...
namespace ClemEngine
{
	...
	void SceneHierarchyPanel::OnImGuiRender()
	{
		...
		if (m_SelectionContext)
		{
			...
			auto centralizedCursorpos = (ImVec2{ initialCursorPos.x + (windowSize.x * 0.5f) - ((windowSize.x - 60) * 0.5f), initialCursorPos.y });

			ImGui::SetCursorPos(centralizedCursorpos);
			bool show = ImGui::Button("Add Component", ImVec2{ windowSize.x - 60, 25 });
			...
			if (ImGui::BeginPopup("AddComponent"))
			{
				if (ImGui::MenuItem("Camera"))
				{
					if (!m_SelectionContext.HasComponent<CameraComponent>())
						...
						CE_CORE_WARN("This entity already has the Camera Component!");
				...
				if (ImGui::MenuItem("Sprite Renderer"))
				{
					if (!m_SelectionContext.HasComponent<SpriteRendererComponent>())
						...
						CE_CORE_WARN("This entity already has the Sprite Renderer Component!");
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		ImGuiTreeNodeFlags flags = ((m_SelectionContext == entity) ? ImGuiTreeNodeFlags_Selected : 0) | ImGuiTreeNodeFlags_Leaf | ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_OpenOnDoubleClick | ImGuiTreeNodeFlags_SpanAvailWidth;
